...
extern std::string Keys[NumKeys];
extern std::unordered_map<std::string, int> KeyIndex;
extern bool CanAttack[NumKeys];
extern int DimensionRight[NumKeys];
extern int Height[NumKeys];
extern bool IsMineralField[NumKeys];
extern bool CanProduce[NumKeys];
extern bool IsRefinery[NumKeys];
extern bool IsResourceDepot[NumKeys];
extern bool RegeneratesHP[NumKeys];
extern bool IsCloakable[NumKeys];
extern bool IsTwoUnitsInOneEgg[NumKeys];
extern bool IsSpellcaster[NumKeys];
extern int SupplyRequired[NumKeys];
extern std::string AirWeapon[NumKeys];
extern int BuildScore[NumKeys];
extern int MaxAirHits[NumKeys];
extern bool IsPowerup[NumKeys];
extern bool IsBeacon[NumKeys];
extern int MineralPrice[NumKeys];
extern bool IsInvincible[NumKeys];
extern std::string RequiredTech[NumKeys];
extern int DimensionDown[NumKeys];
extern bool CanBuildAddon[NumKeys];
extern int DimensionLeft[NumKeys];
extern bool ProducesLarva[NumKeys];
extern int Armor[NumKeys];
extern bool IsMechanical[NumKeys];
extern bool IsBuilding[NumKeys];
extern int SupplyProvided[NumKeys];
extern int SightRange[NumKeys];
extern int GasPrice[NumKeys];
extern int MaxHitPoints[NumKeys];
extern int Width[NumKeys];
extern int TileWidth[NumKeys];
extern bool IsHero[NumKeys];
extern int SeekRange[NumKeys];
extern int BuildTime[NumKeys];
extern bool IsCritter[NumKeys];
extern bool RequiresPsi[NumKeys];
extern bool IsSpecialBuilding[NumKeys];
extern std::string GroundWeapon[NumKeys];
extern bool IsFlyer[NumKeys];
extern std::string Size[NumKeys];
extern bool IsNeutral[NumKeys];
extern int MaxShields[NumKeys];
extern bool HasPermanentCloak[NumKeys];
extern double TopSpeed[NumKeys];
extern int TileHeight[NumKeys];
extern bool IsRobotic[NumKeys];
extern int DimensionUp[NumKeys];
extern int DestroyScore[NumKeys];
extern int SpaceProvided[NumKeys];
extern std::string TileSize[NumKeys];
extern int HaltDistance[NumKeys];
extern bool IsAddon[NumKeys];
extern bool CanMove[NumKeys];
extern bool IsFlyingBuilding[NumKeys];
extern int MaxEnergy[NumKeys];
extern bool IsDetector[NumKeys];
extern bool IsOrganic[NumKeys];
extern int SpaceRequired[NumKeys];
extern bool IsFlagBeacon[NumKeys];
extern bool IsWorker[NumKeys];
extern bool IsBurrowable[NumKeys];
extern std::string CloakingTech[NumKeys];
extern bool IsResourceContainer[NumKeys];
extern int Acceleration[NumKeys];
extern bool IsSpell[NumKeys];
extern bool RequiresCreep[NumKeys];
extern std::string ArmorUpgrade[NumKeys];
extern int MaxGroundHits[NumKeys];
extern int TurnRadius[NumKeys];
extern std::string GetRace[NumKeys];
