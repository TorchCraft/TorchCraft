...
curl -LO https://github.com/TorchCraft/TorchCraft/releases/download/v1.2-1/torchcraft-v1.2-1.zip
unzip torchcraft-v1.2-1.zip
cp torchcraft-v1.2-1/* ./
cp torchcraft-v1.2-1/bin/* ./
