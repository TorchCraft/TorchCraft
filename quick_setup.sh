...
curl -LO https://github.com/TorchCraft/TorchCraft/releases/download/v1.3-1/torchcraft-v1.3-1.zip
unzip torchcraft-v1.3-1.zip
cp torchcraft-v1.3-1/* ./
cp torchcraft-v1.3-1/bin/* ./
